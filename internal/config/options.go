...
type Options struct {
	...
	//UserConfirmation            string `yaml:"UserConfirmation" json:"-" flag:"user-confirmation"` // admin, reset-password, email, none
	...
	//OAuth2AuthorizationEndpoint string `yaml:"OAuth2AuthorizationEndpoint" json:"-" flag:"auth-endpoint"`
	//OAuth2TokenEndpoint         string `yaml:"OAuth2TokenEndpoint" json:"-" flag:"token-endpoint"`
