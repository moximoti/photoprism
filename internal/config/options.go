...
type Options struct {
	...
	AuthProvider          string `yaml:"AuthProvider" json:"-" flag:"auth-provider"`
	OAuth2ClientID        string `yaml:"OAuth2ClientID" json:"-" flag:"client-id"`
	OAuth2ClientSecret    string `yaml:"OAuth2ClientSecret" json:"-" flag:"client-secret"`
	OIDCDiscoveryEndpoint string `yaml:"OIDCDiscoveryEndpoint" json:"-" flag:"discovery-endpoint"`
	DisableRegistration   bool   `yaml:"DisableRegistration" json:"-" flag:"disable-registration"`
	AdminConfirmation     bool   `yaml:"AdminConfirmation" json:"-" flag:"admin-confirmation"`
	EmailConfirmation     bool   `yaml:"EmailConfirmation" json:"-" flag:"email-confirmation"`
	MailHost              string `yaml:"MailHost" json:"-" flag:"mail-host"`
	MailFrom              string `yaml:"MailFrom" json:"-" flag:"mail-from"`
	MailUsername          string `yaml:"MailUsername" json:"-" flag:"mail-username"`
	MailPassword          string `yaml:"MailPassword" json:"-" flag:"mail-password"`
	//PasswordPolicy              string `yaml:"PasswordPolicy" json:"-" flag:"password-policy"` // strong, lax, none
}
